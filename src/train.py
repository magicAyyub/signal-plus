...
if __name__ == '__main__': 
    ...
    # Device configuration - M3 GPU support
    ...
    # To use your own model, change the repo_id to 'YOUR_USERNAME/signdetr-pretrained'
    model.load_pretrained_from_hf('MagicAyyub/signdetr-pretrained', '4426_model.pt', device=device)
    model.to(device)
